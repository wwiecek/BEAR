...
**Reference:**
@rodriguez2022psymetadata

**Snapshot date:**
Jan 2026

**Research question:**
psymetadata is an R package that curates multiple open datasets from published meta-analyses in psychology for teaching and demonstrations. In BEAR we use it as a convenient source of many small-to-medium meta-analytic datasets, standardised into a single schema.
