...
**Data availability:**
file `Mandatory data-sharing 30 Aug 2022.dta` may be downloaded from <https://github.com/anthonydouc/Datasharing/blob/master/Stata/>; 
reproducibility package at <https://dataverse.harvard.edu/file.xhtml?fileId=7884702&version=1.0>
...
**Notes:**
Askarov et al article starts from the Ioannidis-Stanley-Doucouliagos dataset, same as 
in the case of Arel-Bundock et al (another dataset in BEAR). Both datasets 
incorporate additional data and target different fields of research, but 
there is likely a lot of overlap between the two sets.
