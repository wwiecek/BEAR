% Paper-specific appendix, maintained by hand.
...
The analysis in the paper is based on the second release of the BEAR
dataset (June 2026), available at
\url{https://github.com/wwiecek/BEAR/releases/tag/v2}.

\begingroup
\setlength{\parskip}{0.35\baselineskip}
\let\datasetsitemize\itemize
\let\enddatasetsitemize\enditemize
...
\texttt{psymetadata} R package (CRAN). After separately representing the
intelligence meta-meta-analysis, the psychology datasets used here range
...
\subsection{Costello and Fox 2022 (ecology and
evolution)}\label{costello-and-fox-2022-ecology-and-evolution}

\textbf{Reference:} \textcite{costello2022decline}.

\textbf{Research question:} decline effects in ecology and evolution.
...
includes 88,000 rows across 466 analyses in 232 papers.

\textbf{Data availability:} The dataset may be downloaded from
\url{https://github.com/Yefeng0920/replication_EcoEvo_git/}. It is
available under a CC BY 4.0 licence.

\textbf{Data processing:} We cleaned study years and computed signed
z-values as effect sizes divided by their standard errors. In
\texttt{BEAR.rds}, we re-label the effect measures as SMD, response
...
\begin{itemize}
\item
  \textbf{Study ID:} we use \texttt{study2}.
\item
  \textbf{Meta-analysis ID:} we use \texttt{meta.analysis.id}.
\item
  \textbf{Topic:} ecology, evolution or other ecology/evolution.
\item
  The primary-study design is not classified.
\item
  Effects are standardised mean differences, log response ratios,
  Fisher's z correlations, or less common measures. Less common measures
  include regression coefficients, log odds ratios and mean differences.
  Some standardised mean differences are recorded as absolute values.
\end{itemize}
...
2018 in 25 leading economics journals. The sample consists mainly of
natural, laboratory, or field experiments, excluding articles focused on
theory, structural estimation, or econometric methods.
