...
results <- lookup_identifiers(papers,
  "data_raw/Brodeur/derived/crossref_journal_v3.rds")
...
if (file.exists("brodeur_doi_decisions.csv")) {
  decisions <- read_csv("brodeur_doi_decisions.csv", show_col_types = FALSE) %>%
