library(dplyr)
library(stringr)
eff <- readRDS("data_raw/clinicaltrials.gov/derived/clinicaltrials.gov_aug2025.rds")
...
saveRDS(z_table_small, "data_raw/clinicaltrials.gov/derived/data_cut_with_z.rds")
